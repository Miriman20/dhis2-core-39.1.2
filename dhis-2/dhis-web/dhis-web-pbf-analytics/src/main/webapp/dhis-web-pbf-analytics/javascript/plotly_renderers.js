(function() {
  ...
  callWithJQuery(function($, Plotly) {
    ...
    return $.pivotUtilities.plotly_renderers = {
      "Horizontal Barchart": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'group'
      }, true),
      "Horizontal stacked Barchart": makePlotlyChart({
        type: 'bar',
        orientation: 'h'
      }, {
        barmode: 'relative'
      ...
      "Distribution diagram": makePlotlyScatterChart(),
      'Multiple Pie Charts': makePlotlyChart({
        type: 'pie',
        scalegroup: 1,
